...
El mejor menor valor para los K vecinos del modelo es de 13


# Resultados

Para poner en contexto el modelo entrenado 
...
```{r MSE y RMSE}
metricas_de_error<-mse_y_rmse(datos_validacion,resultados_validacion)
kable(metricas_de_error, caption='MSE y RMSE para los datos de validación')
```
