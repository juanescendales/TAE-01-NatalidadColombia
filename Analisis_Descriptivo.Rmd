...
variables_categoricas_p <- datos_pareja %>% 
  select(Sexo.Jefe,Sexo.Conyuge,Tipo.Union,Region,Trabajo.Jefe,Trabajo.conyuge,Edu.Jefe,Edu.Conyuge,Estrato.vivienda,Uso.tecnologia.Jefe,Uso.tecnologia.conyuge,Afiliacion.salud,N.usos.Lavadora) %>% 
  mutate_if(is.numeric,as.factor)

variables_categoricas_s <- datos_soltero %>% 
  select(Sexo.Jefe,Region,Trabajo.Jefe,Edu.Jefe,Uso.tecnologia.Jefe,Afiliacion.salud,N.usos.Lavadora) %>% 
  mutate_if(is.numeric,as.factor)

variables_numericas_p <- datos_pareja %>% 
  select(-c(Sexo.Jefe,Sexo.Conyuge,Tipo.Union,Region,Trabajo.Jefe,Trabajo.conyuge,Edu.Jefe,Edu.Conyuge,Estrato.vivienda,Uso.tecnologia.Jefe,Uso.tecnologia.conyuge,Afiliacion.salud,N.usos.Lavadora))

variables_numericas_s <- datos_soltero %>% 
  select(-c(Sexo.Jefe,Region,Trabajo.Jefe,Edu.Jefe,Uso.tecnologia.Jefe,Afiliacion.salud,N.usos.Lavadora))
