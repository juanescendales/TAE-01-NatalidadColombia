...
kable(descripcion_variables_numericas, col.names = nombre_variables_numericas, caption='Medidas de localización variables numéricas')
kable(desviaciones_estandar, col.names = nombre_variables_numericas, caption = 'Desviaciones estándas variables numéricas')

kable(descripcion_variables_categoricas, caption='Exploración inicial variables categóricas', col.names = nombre_variables_categoricas)
...
kable(caracterizacion_datos, caption = 'Información de los datos', col.names = c('Cantidad de datos','Tipo de dato de salida', 'Dato máximo de la salida', 'Dato mínimo de la salida'))
```
...
crear_modelo_random_forest <- function(datos_entrenamiento,datos_entrada_entrenamiento){
  ...
  mtry <- ncol(datos_entrada_entrenamiento)/3 #Variables seleccionadas 
